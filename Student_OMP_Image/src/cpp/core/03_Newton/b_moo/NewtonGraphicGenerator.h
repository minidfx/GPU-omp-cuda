...
class NewtonGraphicGenerator: public AnimableFonctionel_I
	...
	// -------------------------
	NewtonGraphicGenerator(unsigned int width, unsigned int height, unsigned int max, DomaineMath *ptrMathDomain, NewtonMath *ptrNewtonMath, string title);
	...
	// ----------------------------------------------------------------------------
	void workPixel(uchar4* ptrColorIJ, int i, int j, const DomaineMath& mathDomain);
